...
<head>
    ...
    <title>Pendaftaran Rekrutmen HIMSI UBSI 2026 | Pimpin Masa Depan</title>
    ...
    <style>
        ...
        @keyframes float3dBounce {
            ...
            50% {
                transform: translateY(-24px) rotate(6deg) scale(1.08);
            }
        }
        ...
        @keyframes float3dBounceAlt {
            ...
            50% {
                transform: translateY(22px) rotate(-6deg) scale(0.94);
            }
        }
        ...
        .anim-3d-bounce-alt {
            animation: float3dBounceAlt 6.5s ease-in-out infinite;
        }
...
<body class="bg-[#030712] text-white selection:bg-amber-400 selection:text-slate-950 overflow-x-hidden">
    ...
    <div x-data="{
        ...
        <div
            class="absolute inset-0 bg-[linear-gradient(to_right,#ffffff08_1px,transparent_1px),linear-gradient(to_bottom,#ffffff08_1px,transparent_1px)] bg-[size:3.5rem_3.5rem] pointer-events-none z-0">
        </div>

        <!-- Dynamic Cosmic Ambient Glow Orbs -->
        <div aria-hidden="true" class="pointer-events-none absolute inset-0 overflow-hidden z-0">
            <div
                class="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[600px] bg-gradient-to-tr from-[#001b79]/45 via-[#0453cd]/30 to-indigo-600/35 rounded-full blur-[150px] opacity-80 anim-glow">
            </div>
            <div class="absolute top-2/3 right-10 w-[700px] h-[700px] bg-purple-900/35 rounded-full blur-[170px] opacity-60 anim-glow"
                style="animation-delay: 2s;"></div>
            <div class="absolute bottom-1/4 left-10 w-[600px] h-[600px] bg-amber-500/15 rounded-full blur-[160px] opacity-50 anim-glow"
        ...
        <section class="relative z-10 pt-28 pb-20 lg:pt-36 lg:pb-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
            ...
            <div class="anim-3d-bounce absolute top-20 left-4 hidden lg:block pointer-events-none opacity-85 z-20">
                <div
                    class="w-24 h-24 rounded-full bg-gradient-to-br from-amber-400 via-amber-600 to-indigo-900 shadow-[0_0_40px_rgba(245,158,11,0.6)] border border-amber-300/50 flex items-center justify-center">
            ...
            <div class="anim-3d-bounce-alt absolute top-28 right-6 hidden lg:block pointer-events-none opacity-85 z-20">
                <div
                    class="w-28 h-28 rounded-3xl bg-gradient-to-tr from-blue-600 via-purple-600 to-indigo-900 shadow-[0_0_50px_rgba(59,130,246,0.7)] border border-blue-400/50 rotate-12 flex items-center justify-center backdrop-blur-md">
            ...
            <!-- Animated Top Badge -->
            <div
                class="anim-float inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full bg-white/10 border border-amber-400/50 text-amber-300 text-xs sm:text-sm font-black backdrop-blur-md shadow-[0_0_30px_rgba(245,158,11,0.3)] mb-8">
            ...
            <!-- Main Title H1 -->
            <h1
                class="text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight leading-tight text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-100 to-amber-300 drop-shadow-[0_0_40px_rgba(255,255,255,0.25)] max-w-5xl mx-auto">
            ...
            <p class="mt-6 text-base sm:text-xl text-slate-300 font-medium max-w-3xl mx-auto leading-relaxed">
                Bergabunglah bersama keluarga besar <span class="text-amber-400 font-bold">HIMSI UBSI</span>. Asah
                potensi diri, bangun portofolio nyata, dan ciptakan karya teknologi serta kepemimpinan yang berdampak!
            </p>
            ...
            <div class="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto pt-8 border-t border-white/10">
                <div
                    class="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md hover:scale-105 transition-transform">
                ...
                <div
                    ...
                    <span class="text-xs text-slate-400 font-semibold uppercase tracking-wider">Gratis
                        Pendaftaran</span>
                </div>
                <div
                    class="p-4 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md hover:scale-105 transition-transform">
        ...
        <section id="about-recruitment" class="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            <div class="anim-3d-bounce-alt absolute -top-10 right-8 hidden lg:block pointer-events-none opacity-70">
                <div
                    class="w-20 h-20 rounded-full bg-gradient-to-tr from-emerald-500 via-teal-600 to-indigo-900 shadow-[0_0_35px_rgba(16,185,129,0.5)] border border-emerald-400/40">
                </div>
            </div>
            ...
            <div class="text-center space-y-3 mb-16">
                ...
                <p class="text-slate-400 text-sm sm:text-base max-w-2xl mx-auto">Pengalaman organisasi di HIMSI UBSI
                    memberikan nilai tambah nyata untuk masa depan karirmu.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Benefit 1 -->
                <div
                    class="group p-8 rounded-3xl bg-gradient-to-b from-white/10 to-white/5 border border-white/10 hover:border-blue-500/50 backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(59,130,246,0.3)]">
                    <div
                        class="h-14 w-14 rounded-2xl bg-blue-500/20 text-blue-400 border border-blue-500/40 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    ...
                    <h3 class="text-xl font-bold text-white mb-3">Portofolio & Proyek Nyata</h3>
                    <p class="text-sm text-slate-300 leading-relaxed">Terlibat langsung dalam eksekusi event IT
                        nasional, manajemen media, dan pengembangan proyek digital nyata.</p>
                </div>

                <!-- Benefit 2 -->
                <div
                    class="group p-8 rounded-3xl bg-gradient-to-b from-white/10 to-white/5 border border-white/10 hover:border-amber-500/50 backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(245,158,11,0.3)]">
                    <div
                        class="h-14 w-14 rounded-2xl bg-amber-500/20 text-amber-400 border border-amber-500/40 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                        <svg class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m.94 3.198l.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0112 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 016 18.719m12 0a5.971 5.971 0 00-.941-3.197m0 0A5.995 5.995 0 0012 12.75a5.995 5.995 0 00-5.058 2.772m0 0a5.97 5.97 0 00-.942 3.197" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-white mb-3">Kepemimpinan & Keterampilan Diri</h3>
                    <p class="text-sm text-slate-300 leading-relaxed">Asah kemampuan *public speaking*, manajemen
                        waktu, diplomasi, serta kepemimpinan yang dibutuhkan di dunia kerja.</p>
                </div>

                <!-- Benefit 3 -->
                <div
                    class="group p-8 rounded-3xl bg-gradient-to-b from-white/10 to-white/5 border border-white/10 hover:border-purple-500/50 backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_0_40px_rgba(168,85,247,0.3)]">
                    <div
                        class="h-14 w-14 rounded-2xl bg-purple-500/20 text-purple-400 border border-purple-500/40 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                        <svg class="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M16.5 18.75h-9m9 0a3 3 0 003-3V8.25a3 3 0 00-3-3h-9a3 3 0 00-3 3v7.5a3 3 0 003 3m9 0v-1.5a2.25 2.25 0 00-2.25-2.25h-4.5A2.25 2.25 0 006.75 15v1.5" />
                        </svg>
                    </div>
                    <h3 class="text-xl font-bold text-white mb-3">Jejaringan & Networking</h3>
                    <p class="text-sm text-slate-300 leading-relaxed">Perluas relasi ke sesama mahasiswa Sistem
                        Informasi se-Indonesia, alumni berprestasi, dan mitra industri.</p>
                </div>
            </div>
        </section>
        ...
        <section id="divisions" class="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            <div class="anim-3d-bounce absolute top-12 left-6 hidden lg:block pointer-events-none opacity-75">
                <div
                    class="w-24 h-24 rounded-2xl bg-gradient-to-br from-amber-500 via-purple-600 to-indigo-900 rotate-45 border border-amber-300/40 shadow-[0_0_40px_rgba(245,158,11,0.5)] flex items-center justify-center">
            ...
            <div class="text-center space-y-3 mb-16">
                ...
                <h2 class="text-3xl sm:text-5xl font-black tracking-tight text-white">PILIH DIVISI ANDA</h2>
                <p class="text-slate-400 text-sm sm:text-base max-w-2xl mx-auto">Pilihlah divisi yang paling sesuai
                    dengan passion dan minat pengembangan diri Anda.</p>
            </div>
                    ...
                    <div class="group relative rounded-3xl bg-gradient-to-b from-white/10 via-white/5 to-transparent border border-white/15 p-6 sm:p-7 flex flex-col justify-between overflow-hidden backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:border-amber-400/60"
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between">
                                <span
                                    class="px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-widest bg-white/10 text-amber-300 border border-white/15">
                                    {{ $div['badge'] }}
                                </span>
                            </div>

                            <h3
                                class="text-xl sm:text-2xl font-black text-white group-hover:text-amber-300 transition-colors leading-tight">
                                {{ $div['name'] }}
                            </h3>
        ...
        <section id="timeline" class="relative z-10 py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            ...
            <div class="anim-3d-bounce-alt absolute top-20 right-8 hidden lg:block pointer-events-none opacity-75">
                <div
                    class="w-22 h-22 rounded-full bg-gradient-to-tr from-blue-500 via-indigo-600 to-purple-900 border border-blue-400/40 shadow-[0_0_40px_rgba(59,130,246,0.6)]">
                </div>
            </div>

            <div class="text-center space-y-3 mb-16">
                <span class="text-xs font-black uppercase tracking-[0.25em] text-blue-400">Jadwal & Tahapan</span>
                <h2 class="text-3xl sm:text-5xl font-black tracking-tight text-white">TAHAPAN SELEKSI REKRUTMEN</h2>
                <p class="text-slate-400 text-sm sm:text-base max-w-2xl mx-auto">Alur perjalanan pendaftaran dan
                    seleksi calon pengurus HIMSI UBSI 2026</p>
            </div>
            ...
            <div class="relative max-w-5xl mx-auto py-6">
                ...
                <div
                    class="absolute left-4 md:left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-500 via-amber-400 to-purple-600 -translate-x-1/2 rounded-full shadow-[0_0_15px_rgba(245,158,11,0.5)]">
                </div>
                ...
                <div class="space-y-12 sm:space-y-16">
                    @foreach ($timelines as $index => $time)
                        <div class="relative flex flex-col md:flex-row items-start md:items-center">
                            ...
                            <div
                                class="absolute left-4 md:left-1/2 -translate-x-1/2 top-8 md:top-1/2 md:-translate-y-1/2 h-8 w-8 rounded-full border-4 border-amber-400 bg-[#030712] shadow-[0_0_20px_rgba(245,158,11,0.8)] z-20 flex items-center justify-center">
                                <span class="h-2 w-2 rounded-full bg-amber-400 animate-ping"></span>
                            </div>

                            <!-- Timeline Card Box (Alternating Left & Right) -->
                            <div
                                class="w-full pl-12 md:pl-0 {{ $index % 2 === 0 ? 'md:w-[46%] md:mr-auto md:pr-4 text-left' : 'md:w-[46%] md:ml-auto md:pl-4 text-left' }}">
                                <div
                                    class="group rounded-3xl bg-gradient-to-b from-white/10 via-white/5 to-transparent p-6 sm:p-8 border border-white/15 backdrop-blur-xl shadow-2xl hover:border-amber-400/60 hover:scale-105 transition-all duration-300 space-y-4">

                                    <!-- Step Number & Date -->
                                    <div class="flex items-center justify-between">
                                        <span
                                            class="text-3xl sm:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r {{ $time['color'] }}">
                                            {{ $time['step'] }}
                                        </span>
                                        <span
                                            class="px-3.5 py-1 rounded-full text-xs font-black bg-amber-400/20 text-amber-300 border border-amber-400/40">
                                            {{ $time['date'] }}
                                        </span>
                                    </div>
                                    ...
                                    <!-- Title -->
                                    <h3
                                        class="text-xl sm:text-2xl font-black text-white group-hover:text-amber-300 transition-colors">
                                        {{ $time['title'] }}
                                    </h3>
        ...
        <section id="faq" class="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            <div class="text-center space-y-3 mb-16">
                ...
                <h2 class="text-3xl sm:text-5xl font-black tracking-tight text-white">PERTANYAAN YANG SERING DITANYAKAN
                </h2>
            </div>
            ...
            <div class="space-y-4">
                @foreach ($faqs as $index => $faq)
                    <div
                        class="rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md overflow-hidden transition-colors">
        ...
        <section class="relative z-10 py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto text-center">
            <div
                class="relative rounded-3xl bg-gradient-to-r from-[#001b79] via-[#0453cd] to-[#000c46] p-10 sm:p-16 border border-blue-400/30 overflow-hidden shadow-[0_0_60px_rgba(4,83,205,0.4)]">
                <div class="relative z-10 space-y-6">
                    <span
                        class="inline-block px-4 py-1.5 rounded-full bg-amber-400 text-slate-950 font-black text-xs uppercase tracking-widest">
                    ...
                    <p class="text-slate-200 text-sm sm:text-lg max-w-2xl mx-auto font-medium">
                        Jangan lewatkan kesempatan berharga ini. Daftarkan diri Anda sekarang dan mari bertumbuh bersama
                        kami!
                    </p>
        ...
        <template x-teleport="body">
            <div x-show="openModal" x-transition:enter="transition ease-out duration-300"
                ...
                x-transition:leave-end="opacity-0 scale-95" @click="openModal = false"
                ...
                <div @click.stop
                    ...
                    <div
                        class="absolute -top-24 -right-24 w-64 h-64 bg-amber-400/20 rounded-full blur-3xl pointer-events-none">
                    </div>

                    <!-- Close Button -->
                    <button @click="openModal = false"
                        class="absolute top-5 right-5 text-slate-400 hover:text-white p-2 rounded-full hover:bg-white/10 transition-colors z-20">
                    ...
                    <div class="space-y-3 relative z-10" x-if="selectedDivision">
                        <div class="flex items-center gap-3">
                            <span
                                class="px-4 py-1.5 rounded-full text-xs font-black bg-amber-400/20 text-amber-300 border border-amber-400/40 uppercase tracking-widest"
                    ...
                    <div
                        class="p-5 rounded-2xl bg-white/5 border border-white/10 space-y-2 relative z-10 backdrop-blur-md">
                        <h4
                            class="text-xs font-black uppercase tracking-widest text-amber-400 flex items-center gap-1.5">
                            <span>📖</span>
                            <span>Deskripsi Lengkap Divisi</span>
                        </h4>
                        <p class="text-sm sm:text-base text-slate-200 leading-relaxed font-medium"
                            x-text="selectedDivision?.description"></p>
                    </div>

                    <!-- Kualifikasi & Tugas Utama -->
                    <div
                        class="space-y-3 p-5 rounded-2xl bg-white/5 border border-white/10 relative z-10 backdrop-blur-md">
                        ...
                        <ul class="space-y-3 text-xs sm:text-sm text-slate-200">
                            <template x-for="(req, i) in selectedDivision?.requirements" :key="i">
                                <li class="flex items-start gap-3">
                                    <span
                                        class="h-5 w-5 rounded-full bg-amber-400/20 text-amber-400 border border-amber-400/40 flex items-center justify-center text-xs font-black shrink-0 mt-0.5">✓</span>
                    ...
                    <!-- Modal Actions -->
                    <div
                        class="pt-4 border-t border-white/10 flex flex-col sm:flex-row justify-end gap-3 relative z-10">
                        <button @click="openModal = false"
                            class="px-6 py-3 rounded-xl bg-white/10 text-white font-extrabold text-sm hover:bg-white/20 transition-colors">
                            Tutup
                        </button>
                        <a href="{{ route('recruitment.create') }}"
    ...
    <div class="fixed bottom-6 right-6 z-[9999]">
        <a href="https://wa.me/6281234567890" target="_blank" rel="noopener" title="Hubungi Kami via WhatsApp"
