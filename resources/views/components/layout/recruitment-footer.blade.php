<footer class="relative bg-[#02050e] text-white font-sans overflow-hidden border-t border-white/10 isolate pt-16 pb-12">
    ...
    <style>
        ...
        .anim-3d-prism { animation: rotate3dPrism 15s linear infinite; }
        ...
        .border-pulse { animation: borderPulse 4s infinite; }
    </style>

    <!-- Cyber Background Stars, Grid & 3D Objects Ambient Backdrop -->
    <div class="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <!-- Cyber Mesh Background Grid -->
        <div class="absolute inset-0 bg-[linear-gradient(to_right,#ffffff08_1px,transparent_1px),linear-gradient(to_bottom,#ffffff08_1px,transparent_1px)] bg-[size:3.5rem_3.5rem]"></div>

        <!-- Ambient Nebula Glow Orbs -->
        <div class="absolute top-[-30%] left-[-10%] w-[60%] h-[160%] bg-gradient-to-tr from-blue-600/15 via-indigo-600/10 to-transparent blur-[140px] rounded-full"></div>
        <div class="absolute bottom-[-30%] right-[-10%] w-[60%] h-[160%] bg-gradient-to-bl from-purple-600/15 via-amber-500/10 to-transparent blur-[150px] rounded-full"></div>
        ...
        <div class="anim-3d-bounce absolute bottom-12 right-12 hidden xl:block z-10 opacity-75" style="animation-delay: 2.5s;">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 space-y-12">
        ...
        <!-- Top Banner CTA Card -->
        <div class="relative rounded-3xl bg-gradient-to-r from-slate-900/90 via-[#001b79]/60 to-slate-900/90 border border-pulse p-8 sm:p-12 backdrop-blur-2xl shadow-[0_0_50px_rgba(0,27,121,0.5)] flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden">
            <!-- 3D Floating Badge inside Banner -->
            <div class="space-y-2 text-center md:text-left">
                <div class="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-amber-400/20 text-amber-300 border border-amber-400/40 text-xs font-black uppercase tracking-widest">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
            ...
            <div class="lg:col-span-2 space-y-5">
                <div class="flex items-center gap-3.5">
                    <div class="relative group">
                        <div class="absolute -inset-1 rounded-2xl bg-gradient-to-r from-amber-400 via-blue-500 to-purple-600 blur-sm opacity-75 group-hover:opacity-100 transition-opacity"></div>
                        <img src="{{ asset('images/himsi.png') }}" alt="Logo HIMSI" class="relative w-12 h-12 rounded-xl bg-white p-1 shadow-2xl object-contain">
                    </div>
                    <div>
                        <h2 class="text-2xl font-black tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-200 to-amber-400">
                            HIMSI REKRUTMEN
                        </h2>
                ...
                <p class="text-slate-300 text-sm leading-relaxed max-w-md font-medium">
                    Wadah resmi transformasi kepemimpinan dan inovasi teknologi bagi seluruh mahasiswa Sistem Informasi UBSI. Bergabunglah dan bertumbuh bersama kami!
                </p>

                <!-- Live Status Card -->
                <div class="inline-flex items-center gap-3 p-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md">
                    <span class="h-3 w-3 rounded-full bg-emerald-400 animate-ping"></span>
                    <span class="text-xs font-bold text-emerald-300 uppercase tracking-wider">Status: Pendaftaran Online Dibuka</span>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <ul class="space-y-2.5 text-xs font-bold text-slate-300">
                    <li>
                        <a href="{{ route('home') }}" class="hover:text-amber-300 transition-all flex items-center gap-1 group">
                            <span class="group-hover:-translate-x-1 transition-transform">←</span>
                            <span>Main Web HIMSI</span>
                        </a>
                    </li>
                    <li>
                        <a href="#about-recruitment" class="hover:text-amber-300 transition-all flex items-center gap-1 group">
                            <span class="group-hover:translate-x-1 transition-transform">›</span>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400 font-medium">
            <p>© 2026 HIMSI UBSI Open Recruitment. All rights reserved.</p>
        </div>
    </div>
</footer>
