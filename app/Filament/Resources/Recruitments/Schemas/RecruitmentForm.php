        ...
        return $schema->components([
            Section::make('Informasi Utama')
                ->schema([
                    ...
                    FileUpload::make('follow_dpc')->label('Bukti Follow DPC')->image()->disk('public')->directory('recruitment/follow_dpc')->visibility('public')->preserveFilenames()->maxSize(3072)->helperText('Format gambar. Maksimal 3 MB. Rekomendasi 1600 x 1000 px.')->required(),
