...
class BranchesTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                TextColumn::make('name')->label('Nama Branch')->searchable()->sortable(),
                TextColumn::make('location')->label('Lokasi')->searchable(),
                TextColumn::make('sektor')->label('Sektor')->searchable(),
                IconColumn::make('is_dpp')->label('DPP')->boolean()->sortable(),
            ...
            ->filters([
                ...
                TernaryFilter::make('is_dpp')->label('DPP'),
            ])
            ->recordActions([
